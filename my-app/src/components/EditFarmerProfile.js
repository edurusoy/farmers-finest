...
export default function EditCustomerProfilePage() {
    ...
    async function getFarmerProfile() {
      ...
      async function postDataFarmerProfile(profile) {   
        const response = await fetch("/UpdateFarmerProfile", {
          method: "POST",
          headers: {
      ...
      async function handleSubmit(values) {
        try{
            console.log(values);
            const response = await postDataFarmerProfile(values);
            console.log(response.status);
            if (response.ok){
      ...
      async function deleteFarmerAccount() {
        const response = await fetch("/DeleteFarmerAccount");
        console.log(response.status);
        app.auth().signOut()
      }
    ...
    <Container component="main" maxWidth="xs" >
      ...
      <Button fullWidth variant="outlined"  className={classes.cancelButton} color="secondary" onClick = {deleteFarmerAccount}>Delete Account</Button>
    </Container>
        </div>
       )
      })}
